...
def crear_estudiante(request):
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            estudiante.save()
            return render(request, "AppCoder/inicio.html", {"mensaje":f"Estudiante {estudiante.nombre} creado correctamente"})
        else:
            return render(request, "AppCoder/crear_estudiante.html", {"form": form, "mensaje":"Error al crear el estudiante"})
...
def buscandoEstudiante(request):
    ...
    if apellidoIngresado!="":
        ...
        return render(request, "AppCoder/busquedaEstudiantes.html", {"mensaje": "Che Ingresa un apellido para buscar!"})
